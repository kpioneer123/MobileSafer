...
public class OkHttpUtils
{
    ...
    public void setCertificates(Context pContext,InputStream... certificates) throws IOException
    {
    	
    	InputStream inputStream = pContext.getResources().getAssets().open("client.p12");
        mOkHttpClient = getOkHttpClient().newBuilder()
                .sslSocketFactory(HttpsUtils.getSslSocketFactory(certificates, inputStream, "bkyapp"))
                .build();
    }
